<div class="modal fade" id="AddRockType" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" action="{{action('Admin\AdminRockTypesController@store')}}" method="POST" enctype="multipart/form-data">
					{{csrf_field()}}
